...
@interface DNAutoHeightTextView ()

@property (nonatomic, strong) UILabel    *lenthLab;
@property (nonatomic, strong) UITextView *_placeholderTextView;
@end
...
@implementation DNAutoHeightTextView
...
- (void)preparePlaceholder {
    ...
    self._placeholderTextView.textColor = [UIColor colorWithWhite:0.7f
                                                            alpha:0.7f];
    ...
    if (_attributePlaceholder) {
        
        self._placeholderTextView.attributedText = _attributePlaceholder;
    }
...
- (void)setPlaceholder:(NSString *)placeholderText
{
    ...
    _attributePlaceholder = [[NSAttributedString alloc] initWithString:placeholderText];
...
- (void)setAttributedPlaceholder:(NSAttributedString *)attributedPlaceholderText
{
    ...
    _attributePlaceholder = [attributedPlaceholderText copy];
...
- (void)resizeLengthFrame {
    if (self.showLength) {
        NSString *length = [NSString stringWithFormat:@"%lu", (unsigned long)self.currentLength];
        if (self.maxLength > 0) {
...
- (UILabel *)lenthLab {
    if (!_lenthLab) {
        ...
        _lenthLab.font = [UIFont systemFontOfSize:12];
